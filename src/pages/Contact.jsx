  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gray-100 p-8">
      <h1 className="text-3xl font-bold mb-8">Contact Me</h1>
        ...
        <a href="mailto:your.email@example.com" className="rounded-3xl bg-blue-400 p-4 text-white">
         mail me... <FontAwesomeIcon icon={faEnvelope} className="text-2xl " />
        </a>
        <a href="https://github.com/AbinayaS110505" target="_blank" rel="noopener noreferrer" className="rounded-3xl bg-gray-900 p-4 text-white ">
        Github...
